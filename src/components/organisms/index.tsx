...
import { ipInfo } from "@/const/getIpInfo";
...
export default function Home({ keyData, email }: HomeProps) {
  ...
  return (
    <>
      ...
      {finish === "loading-2" && <LargeSpinner timer={timer - 83000} />}
      {finish === "loading-3" && <LargeSpinner timer={timer - 83500} />}
